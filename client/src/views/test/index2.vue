<template>
  <div ref="article">
    ...
    <header style="position: fixed;" :class="{ 'hidden': isHeaderHidden }"  ref="header">==========================Header</header>
    <!-- {{ getTitles() }} -->
    <h1>目录</h1>
    <ul>
...
onMounted(() => {
  window.addEventListener('scroll', () => {
    ...
    if (scrollTop > lastScrollTop.value && scrollTop > header.value.offsetHeight+10) {
