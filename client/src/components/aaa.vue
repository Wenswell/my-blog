<template>
  <!-- <div class="catalog-card" v-show="Object.keys(titles).length > 0"> -->
...
function getTitles() {
  let titles = [];
  let levels = ["h2", "h3", "h4"];
  console.log("document.querySelector('.aa-bb')", document.querySelector('.aa-bb'))

  let articleElement = document.querySelector('.aa-bb');
  if (!articleElement) {
    return titles;
  }
...
onMounted(() => {
  titles = getTitles()
  console.log("onMounted titles", titles)
})
</script>
